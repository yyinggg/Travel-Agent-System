...
<table width="1467" border="0">
  ...
  <td height="202" colspan="5" align="center" valign="top" bordercolor="#000000" bgcolor="#e6ffff">
    ...
    <center><h1><font size=+3 face="Comic Sans MS"font><strong>Edit Successfully !</strong></font></h1></center>
	  ...
	  <p>
        <?php
			...
			$SQLcommand = "UPDATE `package` SET `country`= '$country', `duration`= '$duration', `title`='$title', `price`='$price',
										`date`='$date', `description`='$description' WHERE `id`=".$Nono;

...
<td width="185"><a href="cust_Homepage.php">HOME</a></td>
  ...
  <div id="intro1"> 
  <h1><center>TRAVEL PACAKGES</center></h1>
	<br>
      <button type="submit" name="sumbit">
      <a href="package_L.php"><b>Fast Book</b></a>
      </button>
  </div>
  <div id="selection">
  <table width="911" border="1" align="center">
	<?php
			...
			$result = mysqli_query($db, $SQLcommand);
			  ...
			  {
				  echo '<tr>';
				  echo '<td width="200" height="250">';
				  echo '<img src="data:image/jpeg;base64,'.base64_encode($row["Image"]).'" height="350" width="350"></td><br>';
				  echo '<td width="350" style="text-align: center">'.$row["title"].'</td>';
				  echo '<td width="100" style="text-align: center">'.$row["price"].'</td>';
				  echo '<td width="80" style="text-align: center"><a href=package.php?id='.$row["id"].';>[View]</a></td>';
				  echo '';
				print "</tr>";			  
			  }
		  print "</table>";

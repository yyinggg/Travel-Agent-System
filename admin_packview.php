...
<table width="1467" border="0">
  ...
  <td height="202" colspan="5" align="center" valign="top" bordercolor="#000000" bgcolor="#e6ffff">
   ...
   <h1><center><font size=+4 face="Comic Sans MS"font><strong>Package View</strong></font></center></h1>
 
	<table border="10" cellpadding="10" width="90%" align="center">
	<?php 		
		$Nono = $_REQUEST['id'];
		...
		while($row = mysqli_fetch_array($result))
		  {
			...
			echo '<img src="data:image/jpeg;base64,'.base64_encode($row["Image"]).'"
						height="400" width="800" align="center"/></tr><br>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Country :</font></td>';
			echo '<td>'.$row["country"].'</td></tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Duration :</font></td>';
			echo '<td>'.$row["duration"].'</td></tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Title :</font></td>';
			echo '<td>'.$row["title"].'</td></tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Price :</font></td>';
			echo '<td>'.$row["price"].'</td></tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Date :</font></td>';
			echo '<td>'.$row["date"].'</td></tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Description :</font></td>';
...
<img src="footer.jpg" width="960" height="50" /></div>

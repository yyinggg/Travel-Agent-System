...
<table width="1467" border="0">
  ...
  <div id="choose">
    <p><center><font size=+4 face="Comic Sans MS"font><strong>Feedback List</strong></font></center>    
  <p>
  ...
  <table border="10" cellpadding="10" width="90%" align="center">
		<?php
			...
			$SQLcommand = "SELECT * FROM feedback";
			...
			print "</tr>";
			  ...
			  while($row = mysqli_fetch_array($result))
			  {
				  ...
				  print "<td><a href=admin_feebackpack.php?id=".$row['No'].";>[View]</a></td>";

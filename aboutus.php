...
<title>About Us | AMUSE TRAVEL AGENCY</title>
<style type="text/css">
	body{
...
<table width="1467" border="0">
  ...
  <div id="nav">
    <table width="960" border="1">
      <tr>
        ...
        <td width="186"><a href="b4feedback.php">FEEDBACK</a></td></td>
      </tr>
    </table>
  </div>
  <div id="intro1"> 
  <h1>About Us</h1>
    ...
    <p>Looking for that unique travel experience with utmost quality? Amuse Travel Agency has you covered. Amuse Travel Agency is here to help you plan the perfect trip.
	The package that we provided is all in Asia like Japan, Korea ,Hong Kong, Malaysia and so on. With our easy-to-use website , along with 24-hour customer
	service, booking your next trip couldn't be simpler.  </p>
    
    <p>Our service include:
    <ul>
    <li>Provide the best value travel package. </li>
    <li>Visa Services</li>

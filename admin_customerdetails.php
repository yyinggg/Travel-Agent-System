...
<table width="1467" border="0">
  ...
  <div id="choose">
    <h1><center><font size=+4 face="Comic Sans MS"font><strong>Customer Details</strong></font></center></h1>
  <p>
		...
		$SQLcommand = "SELECT * FROM userdetails WHERE id=".$Nono;
		...
		while($row = mysqli_fetch_array($result))
		  {
			echo '<tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Name :</font></td>';
			echo '<td>'.$row["name"].'</td></tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Contact Number :</font></td>';
			echo '<td>'.$row["phno"].'</td></tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Email :</font></td>';
			echo '<td>'.$row["email"].'</td></tr>';
			echo '<tr><td><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Username :</font></td>';

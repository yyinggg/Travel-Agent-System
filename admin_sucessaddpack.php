...
<table width="1467" border="0">
  ...
  <td height="202" colspan="5" align="center" valign="top" bordercolor="#000000" bgcolor="#e6ffff">
    ...
    <h1><center><font size=+3 face="Comic Sans MS"font><strong>Add Successfully !</strong></font></center></h1>
...
<?php
      $country= $_POST['country'];
			...
			$Image= addslashes(file_get_contents($_FILES['Originals']['tmp_name']));
						
			$db = mysqli_connect('localhost','root','','tourism');
  			
			$SQLcommand = "INSERT INTO package(`country`, `duration`, `title`, `price`, `date`, `description`, `Image`)
                    VALUES ('$country','$duration', '$title', '$price', '$date', '$description', '$Image')";
